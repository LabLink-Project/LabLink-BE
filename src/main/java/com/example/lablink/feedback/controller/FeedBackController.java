...
public class FeedBackController {
    ...
    @GetMapping()
    public ResponseEntity getFeedBack(@AuthenticationPrincipal CompanyDetailsImpl companyDetails, @PathVariable Long studyId, @RequestBody FeedBackRequestDto feedBackRequestDto){

        return ResponseMessage.SuccessResponse("",feedBackService.getFeedBack(companyDetails,studyId,feedBackRequestDto));
    }

    @Operation(summary = "피드백 상세조회", description = "피드백 상세조회")
    @GetMapping("/feedBackId")
    public ResponseEntity detailFeedBack(@AuthenticationPrincipal CompanyDetailsImpl companyDetails, @PathVariable Long studyId,@PathVariable Long feedbackId, @RequestBody FeedBackRequestDto feedBackRequestDto){
        return ResponseMessage.SuccessResponse("",feedBackService.getDetailFeedBack(companyDetails,studyId,feedbackId,feedBackRequestDto));
    }
}
